...
class Raquete {
    ...
    atualizar() {
        ...
        this.y = constrain(this.y, this.h / 2 + barraSuperior.h
...
class Bola {
    ...
    verificarColisaoRaquete(raquete) {
        if (
            ...
            // Calcula a posição relativa da bola na raquete
            let posicaoRelativa = (this.y - raquete.y) / raquete.h;

            // Limita o ângulo máximo da saída da bola
            // posicaoRelativa = constrain(posicaoRelativa, -0.5, 0.5);

            // Define o ângulo da bola após a colisão
            let anguloBola = posicaoRelativa * PI / 3 * 2;

            // Atualiza a velocidade vertical da bola com a base
